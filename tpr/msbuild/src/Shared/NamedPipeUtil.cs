...
namespace Microsoft.Build.Shared
{
    internal static class NamedPipeUtil
    {
        ...
        internal static string GetPlatformSpecificPipeName(string pipeName)
        {
            ...
            {
#if NET
                // HarmonyOS requires an application-private directory for Unix
                // sockets. The SDK launcher supplies it through TMPDIR.
                if (System.Runtime.InteropServices.RuntimeInformation.RuntimeIdentifier.StartsWith("openharmony-", System.StringComparison.Ordinal))
                {
